...
interface IJurorsRegistry {
    ...
    function slashOrUnlock(uint64 _termId, address[] _jurors, uint256[] _penalties, uint8[] _jurorsRulings, uint8 _winningRuling) external returns (uint256 collectedTokens);
