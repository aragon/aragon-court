  ...
  describe('gas costs', () => {
    describe('insert', () => {
      context('non increasing height', () => {
        context('small tree', () => {
          const expectedCost = 118e3

          itCostsAtMost(expectedCost, () => tree.insert(0, 10))
        })

        context('huge tree', () => {
          const expectedCost = 440e3
